...
- Certify pm CLI 2026.9.23 and adopt the guarded pm-ops merge-driver launcher ([pm-ts-starter-r5s2](https://github.com/unbraind/pm-ts-starter/blob/main/.agents/pm/chores/pm-ts-starter-r5s2.toon))
...
- Certify pm CLI 2026.9.17 ([pm-ts-starter-dtup](https://github.com/unbraind/pm-ts-starter/blob/main/.agents/pm/chores/pm-ts-starter-dtup.toon))
...
- Certify pm CLI 2026.9.10 and pick up the canonical auditor fixes the lockfile was holding back ([pm-ts-starter-it5u](https://github.com/unbraind/pm-ts-starter/blob/main/.agents/pm/chores/pm-ts-starter-it5u.toon))
